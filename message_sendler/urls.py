...
from message_sendler.apps import MessageSendlerConfig
from message_sendler.views import HomeView, ClientListView, ClientCreateView, ClientUpdateView, ClientDeleteView, \
...
app_name = MessageSendlerConfig.name
